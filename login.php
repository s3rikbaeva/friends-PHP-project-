    ...
    color:black;
        ...
        <div class="sign-up-form">
          ...
          <div class="form-wrapper">
            <p class="signup-text">Log in now and meet awesome people around the world</p>
            ...
            <button class="btn-secondary" type="submit" name="do_login">Login</button>
          </div>
          </form>
