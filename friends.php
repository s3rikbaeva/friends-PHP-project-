            ...
            <div class="friend-list">
            	<div class="row">
                  ...
                  <div class="friend-card">
                      ...
                      <div class="friend-info">
                        <a class="pull-right text-green">My Friend</a>
                      	<h5><a class="profile-link">Sophia Lee</a></h5>
                  ...
                  <div class="friend-card">
                      ...
                      <div class="friend-info">
                        <a class="pull-right text-green">My Friend</a>
                      	<h5><a class="profile-link">John Doe</a></h5>
                      	<p>Traveler</p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6 col-sm-6">
                  <div class="friend-card">
                      ...
                      <div class="friend-info">
                        <a class="pull-right text-green">My Friend</a>
                      	<h5><a class="profile-link">Julia Cox</a></h5>
                      	<p>Art Designer</p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6 col-sm-6">
                  <div class="friend-card">
                      ...
                      <div class="friend-info">
                        <a class="pull-right text-green">My Friend</a>
                      	<h5><a class="profile-link">Robert Cook</a></h5>
                ...
                <div class="col-md-6 col-sm-6">
                  <div class="friend-card">
                      ...
                      <div class="friend-info">
                        <a class="pull-right text-green">My Friend</a>
                      	<h5><a class="profile-link">Richard Bell</a></h5>
                ...
                <div class="col-md-6 col-sm-6">
                  <div class="friend-card">
                      ...
                      <div class="friend-info">
                        <a class="pull-right text-green">My Friend</a>
                      	<h5><a class="profile-link">Linda Lohan</a></h5>
                ...
                <div class="col-md-6 col-sm-6">
                  <div class="friend-card">
                      ...
                      <div class="friend-info">
                        <a class="pull-right text-green">My Friend</a>
                      	<h5><a class="profile-link">Anna Young</a></h5>
                      	<p>Musician</p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6 col-sm-6">
                  <div class="friend-card">
                      ...
                      <div class="friend-info">
                        <a class="pull-right text-green">My Friend</a>
                      	<h5><a class="profile-link">James Carter</a></h5>
                      	<p>CEO at IT Farm</p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6 col-sm-6">
                  <div class="friend-card">
                      ...
                      <div class="friend-info">
                        <a class="pull-right text-green">My Friend</a>
                      	<h5><a class="profile-link">Alexis Clark</a></h5>
                      	<p>Traveler</p>
                      </div>
                    </div>
                  </div>
